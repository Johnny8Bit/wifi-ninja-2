...
def send_to_dashboard_wlc(wlc_data):

    commsLib.send_to_dashboard("WLC", wlc_data)


def send_to_dashboard_ap(ap_data):

    commsLib.send_to_dashboard("AP", summarize_rrm_data(ap_data))


def summarize_rrm_data(ap_data):
